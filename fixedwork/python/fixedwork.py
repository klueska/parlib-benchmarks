...
arg_help_strings = {
  'input-folder' : "Name of the input folder where the *.dat files " \
                 + "generated by run-fixedwork reside. Required unless " \
                 + "a config-file is given.",
  'output-folder' : "Name of the output folder where all generated graphs " \
                  + "will be placed. Required unless a config-file is given.",
  'config-file' : "Name of a json file with some configuration information, " \
                + "including the INPUT-FOLDER and OUTPUT-FOLDER, as well as " \
                + "some others. Required if no input-folder and " \
                + "output-folder are given. Any command line argments given " \
...
commands = [
  {
    ...
    'arg_params'  : ['input-folder', 'output-folder', 'config-file'],
