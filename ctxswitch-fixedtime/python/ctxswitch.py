...
from ctxswitch_graphs import ctxswitch_graphs 
...
#######################################################
cmd_help_strings = {
  'ctxswitch-graphs' : "Generate all graphs from the INPUT_FILES and place " \
                  + "them in OUTPUT_FOLDER. Do this acording to the " \
                  + "configuration options in CONFIG-FILE."
}
commands = [
  {
    'name'        : 'ctxswitch-graphs',
    'description' : cmd_help_strings['ctxswitch-graphs'],
    'arg_params'  : ['config-file'],
    'func'        : 'ctxswitch_graphs',
  },
]
